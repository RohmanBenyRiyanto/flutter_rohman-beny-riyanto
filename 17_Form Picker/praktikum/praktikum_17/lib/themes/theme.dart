...
Color primaryColor = const Color(0xFFf6d92f);
Color secondaryColor = const Color(0xFFd9fd39);
Color blackColor = const Color(0xFF15141b);
Color black2Color = const Color(0xFF24222e);
Color tittleColor = const Color(0xFF5E5F5F);
Color greyColor = const Color(0xFFA0A5AC);
Color redColor = const Color(0xffe66456);
Color greenColor = const Color(0xFF2ecbcd);
Color blueColor = const Color(0xFF69F0AE);
