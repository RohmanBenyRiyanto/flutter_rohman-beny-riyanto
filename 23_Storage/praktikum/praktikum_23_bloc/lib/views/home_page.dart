...
import 'package:praktikum_16/bloc/add_contact/contact_event.dart';
...
import 'package:praktikum_16/components/primary_button.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<ContactBloc>(context).add(LoadContact());
  }
        ...
        child: Row(
          ...
          children: <Widget>[
            OutlineIconsButton(
              ...
              press: () {
                BlocProvider.of<ContactBloc>(context).add(ClearContact());
              },
            ),
            Text(
              'Contact',
